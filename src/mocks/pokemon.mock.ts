...
import { ResultPokemon, SmallPokemon } from "src/app/pokemon/interfaces/small-pokemon.interface";

export const smallPokemonMock: SmallPokemon = {
  name: 'pichu',
  url: 'randomUrl'
}

export const resultPokemonMock: ResultPokemon = {
  count: 0,
  next: null,
  previous: null,
  results: [{...smallPokemonMock}]
}
